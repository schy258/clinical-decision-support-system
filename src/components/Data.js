...
import drug1 from '../Json/drug1.json'


export default function Data() {
  // in this part i set my initail state using usestage hook
  const [json1, setJson] = useState(drug1?.fields);
...
// return part
              ...
              {value?.type == "dropdown" ? null :
                <div className="form-group">
                  ...
                  <input type={value?.type}
                    ...
                    aria-describedby="helpId" placeholder={value?.unit} arrange={drug1.fields .sort(function(a,b){return a.order - b.order})} />
                </div>}
  ...
  <thead>
    <tr style={{textAlign:"center"}}>
      ...
      <th scope="col" >Gestational-Age (in weeks)</th>
